...
\begin{figure}
\centering
\subfloat[]{\includegraphics[width=0.18\linewidth]{images/fig-2a.jpg}\label{fig:2a}}\hfil
\subfloat[]{\includegraphics[width=0.36\linewidth]{images/fig-2b.jpg}\label{fig:2b}}\hfil
\subfloat[]{\includegraphics[width=0.36\linewidth]{images/fig-2c.jpg}\label{fig:2c}}
...
\subfloat[Phase offset $\psi=\pi/2$]{
  \includegraphics[width=0.4\linewidth]{images/fig-4a.jpg}
  \label{fig:4a}}
\subfloat[Phase offset $\psi=0$]{
  \includegraphics[width=0.4\linewidth]{images/fig-4b.jpg}
  \label{fig:4b}}
...
\begin{figure}
\centering
\subfloat[Response map]{\includegraphics[width=0.48\linewidth]{images/fig-7a.jpg}\label{fig:7a}}\hfil
\subfloat[Weight matrices]{\includegraphics[width=0.48\linewidth]{images/fig-7b.jpg}\label{fig:7b}}
...
\begin{figure}
\centering
\subfloat[Patterns]{\includegraphics[width=0.24\linewidth]{images/fig-8a.jpg}\label{fig:8a}}\hfil
\subfloat[Response map]{\includegraphics[width=0.24\linewidth]{images/fig-8b.jpg}\label{fig:8b}}\hfil
\subfloat[Response map]{\includegraphics[width=0.24\linewidth]{images/fig-8c.jpg}\label{fig:8c}}\hfil
\subfloat[Response map]{\includegraphics[width=0.24\linewidth]{images/fig-8d.jpg}\label{fig:8d}}
...
{\includegraphics[width=0.9\linewidth]{images/fig-9a.jpg}\label{fig:9a}}\\
\subfloat[Response map of a neuron selective for helix shapes (Selectivity index = 6.37).]%
{\includegraphics[width=0.9\linewidth]{images/fig-9b.jpg}\label{fig:9b}}
...
\begin{figure}
\centering
\subfloat[Patterns]{\includegraphics[width=0.31\linewidth]{images/fig-10a.jpg}\label{fig:10a}}\hfil
\subfloat[Response map]{\includegraphics[width=0.31\linewidth]{images/fig-10b.jpg}\label{fig:10b}}\hfil
\subfloat[Response map]{\includegraphics[width=0.31\linewidth]{images/fig-10c.jpg}\label{fig:10c}}
...
\begin{figure}
\centering
\subfloat[Car image]{\includegraphics[width=0.32\linewidth]{images/fig-11a.jpg}\label{fig:11a}}\hfil
\subfloat[Activity map]{\includegraphics[width=0.32\linewidth]{images/fig-11c.jpg}\label{fig:11b}}\hfil
\subfloat[Entropy map]{\includegraphics[width=0.32\linewidth]{images/fig-11e.jpg}\label{fig:11c}}\\
\subfloat[Face image]{\includegraphics[width=0.32\linewidth]{images/fig-11b.jpg}\label{fig:11d}}\hfil
\subfloat[Activity map]{\includegraphics[width=0.32\linewidth]{images/fig-11d.jpg}\label{fig:11e}}\hfil
\subfloat[Entropy map]{\includegraphics[width=0.32\linewidth]{images/fig-11f.jpg}\label{fig:11f}}\\
\subfloat[Salient points]{\includegraphics[width=0.49\linewidth]{images/fig-11g.jpg}\label{fig:11g}}\hfil
\subfloat[Salient points]{\includegraphics[width=0.49\linewidth]{images/fig-11h.jpg}\label{fig:11h}}
...
\centering
  \subfloat[Matching between the same face]{
    \includegraphics[width=0.8\linewidth]{images/fig-12a.jpg}
    \label{fig:12a}}\\
  \subfloat[Matching between different faces]{
    \includegraphics[width=0.8\linewidth]{images/fig-12b.jpg}
    \label{fig:12b}}
...
\centering
  \subfloat[Our match]{
    \includegraphics[width=0.8\linewidth]{images/fig-13a.jpg}
    \label{fig:13a}}\\
  \subfloat[SIFT match]{
    \includegraphics[width=0.8\linewidth]{images/fig-13b.jpg}
    \label{fig:13b}}
...
\centering
  \subfloat[Sampling density of orientations]{
    \includegraphics[width=0.9\linewidth]{images/fig-15a.eps}
    \label{fig:15a}}\\
  \subfloat[Number of features per image]{
    \includegraphics[width=0.9\linewidth]{images/fig-15b.eps}
    \label{fig:15b}}
...
\centering
  \subfloat[Comparison with other methods]{
    \includegraphics[width=0.9\linewidth]{images/fig-16a.eps}
    \label{fig:16a}}\\
  \subfloat[Comparison with other features]{
    \includegraphics[width=0.9\linewidth]{images/fig-16b.eps}
    \label{fig:16b}}
