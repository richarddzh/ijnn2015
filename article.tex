...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\linewidth]{images/fig3c.eps}
...
\centering
  \subfloat[Sampling density of orientations]{
    \includegraphics[width=0.8\linewidth]{images/fig5a.eps}
    \label{fig:result:density}}\\
  \subfloat[Number of features per image]{
    \includegraphics[width=0.8\linewidth]{images/fig5b.eps}
...
\centering
  \subfloat[Comparison with other methods]{
    \includegraphics[width=0.8\linewidth]{images/fig5c.eps}
    \label{fig:result:ntrain}}\\
  \subfloat[Comparison with other features]{
    \includegraphics[width=0.8\linewidth]{images/fig5d.eps}
